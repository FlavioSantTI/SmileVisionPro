...
- **Framer Motion** para animações de interface de alto nível
- **Lucide React** para iconografia consistente
- **Supabase** para backend escalável e autenticação segura
...
- **Exportação Profissional:** Geração de relatórios em PDF e exportação de pacotes ZIP.

---
*SmileVision Pro - Transformando a visão clínica com inteligência.*
